...
When contributing to Set-OutlookSignatures, please make sure to follow the Code of Conduct ('CODE_OF_CONDUCT' in the same directory as this document).
...
Become a Benefactor Circle member to unlock additional features: See [`Benefactor Circle add-on`](https://set-outlooksignatures.com/benefactorcircle) or [`https://explicitonsulting.at`](https://set-outlooksignatures.com/benefactorcircle) for details about these features and their benefits for your business.
