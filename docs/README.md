...
- Results
  - Telephone number and mobile number are set. The paragraph marks come from `$CURRENTUSERTELEPHONE-PREFIX-NOEMPTY$` and `$CURRENTUSERMOBILE-PREFIX-NOEMPTY$`.  
    <pre><code><a href="mailto:first.last@example.com">first.last@example.com</a><br>Telephone: <a href="tel:+43xxx">+43xxx</a><br>Mobile: <a href="tel:+43yyy">+43yyy</a></code></pre>
  - Telephone number exists, mobile number is empty. The paragraph mark comes from `$CURRENTUSERTELEPHONE-PREFIX-NOEMPTY$`.  
    <pre><code><a href="mailto:first.last@example.com">first.last@example.com</a><br>Telephone: <a href="tel:+43xxx">+43xxx</a></code></pre>
  - Telephone number is empty, mobile number is set. The paragraph mark comes from `$CURRENTUSERMOBILE-PREFIX-NOEMPTY$`.  
    <pre><code>E-Mail: <a href="mailto:first.last@example.com">first.last@example.com</a><br>Mobile: <a href="tel:+43yyy">+43yyy</a></code></pre>
