...
- Avoid additional blank lines at the end of .txt signature files when .doxc templates are used (<a href="https://github.com/GruberMarkus/Set-OutlookSignatures/issues/13" target="_blank">#13</a>)
