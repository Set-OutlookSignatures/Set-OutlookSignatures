...
- [1. English](#1-english)
  ...
  - [1.4. Alignment of signatures between different devices](#14-alignment-of-signatures-between-different-devices)
  - [1.5. Recommendation: Set-OutlookSignatures.ps1](#15-recommendation-set-outlooksignaturesps1)
  ...
  - [1.6. Administration](#16-administration)
    ...
    - [1.6.7. Running operation](#167-running-operation)
      ...
      - [1.6.7.2. Setting and maintaining AD attributes](#1672-setting-and-maintaining-ad-attributes)
      - [1.6.7.3. Configuration adjustments](#1673-configuration-adjustments)
      - [1.6.7.4. Problems and questions during operation](#1674-problems-and-questions-during-operation)
      - [1.6.7.5. Supported versions](#1675-supported-versions)
      - [1.6.7.6. New versions](#1676-new-versions)
      - [1.6.7.7. Adjustments to the code of the product](#1677-adjustments-to-the-code-of-the-product)
- [2. German (Deutsch)](#2-german-deutsch)
  ...
  - [2.5. Empfehlung: Set-OutlookSignatures.ps1](#25-empfehlung-set-outlooksignaturesps1)
  ...
  - [2.6. Administration](#26-administration)
    ...
    - [2.6.7. Laufender Betrieb](#267-laufender-betrieb)
      ...
      - [2.6.7.2. Setzen und Warten von AD-Attributen](#2672-setzen-und-warten-von-ad-attributen)
      - [2.6.7.3. Konfigurationsanpassungen](#2673-konfigurationsanpassungen)
      - [2.6.7.4. Probleme und Fragen im laufenden Betrieb](#2674-probleme-und-fragen-im-laufenden-betrieb)
      - [2.6.7.5. Unterstützte Versionen](#2675-unterstützte-versionen)
      - [2.6.7.6. Neue Versionen](#2676-neue-versionen)
      - [2.6.7.7. Anpassungen am Code des Produkts](#2677-anpassungen-am-code-des-produkts)
...
The service provider recommends a free script-based solution with central administration and extended client-side functionality, which can be operated and maintained by the customers themselves with the support of the service provider. For details see "Recommendation: Set-OutlookSignatures.ps1".  
...
Due to the costs and the fulfilled requirements for functionality and maintainability, the service provider recommends the use of the open source product Set-OutlookSignatures.ps1 and offers its customers support for implementation and operation.  
## 1.4. Alignment of signatures between different devices
...
## 1.5. Recommendation: Set-OutlookSignatures.ps1  
The service provider recommends the free open-source software Set-OutlookSignatures.ps1 after surveying customer requirements and testing several server- and client-based products.  
...
Set-OutlookSignatures.ps1 (https://github.com/GruberMarkus/Set-OutlookSignatures) is a free open source product.  
...
Since Set-OutlookSignatures.ps1 is a pure PowerShell script, it is called like any other script of this file type:  
```  
...
Mail product management is available to advise on feasibility and impact issues.  
#### 1.6.7.3. Configuration adjustments  
...
In the event of fundamental technical problems, Mail Product Management provides support in researching the causes, works out proposals for solutions and, if necessary, establishes contact with the manufacturer of the product.  
#### 1.6.7.7. Adjustments to the code of the product
...
Der Service-Provider empfiehlt eine kostenlose scriptbasierte Lösung mit zentraler Verwaltung und erweitertem clientseitigen Funktionsumfang, die mit Unterstützung des Service-Providers von den Kunden selbst betrieben und gewartet werden kann. Details siehe „Empfehlung: Set-OutlookSignatures.ps1“.  
...
Auf Grund der Kosten und der erfüllten Anforderungen an Funktionalität und Wartbarkeit empfiehlt der Service-Provider die Verwendung des Open-Source-Produkts Set-OutlookSignatures.ps1 und bietet seinen Kunden Unterstützung bei Einführung und Betrieb an.  
...
## 2.5. Empfehlung: Set-OutlookSignatures.ps1  
Der Service-Provider empfiehlt nach einer Erhebung der Kundenanforderungen und Tests mehrerer server- und clientbasierten Produkte die kostenlose Open-Source-Software Set-OutlookSignatures.ps1.  
...
Set-OutlookSignatures.ps1 (https://github.com/GruberMarkus/Set-OutlookSignatures) ist ein kostenloses Open-Source-Produkt.  
...
Da es sich bei Set-OutlookSignatures.ps1 um ein reines PowerShell-Script handelt, erfolgt der Aufruf wie bei jedem anderen Script dieses Dateityps:  
```  
...
Erstellen und Warten von Ablage-Shares für Vorlagen und Script-Komponenten  
Das Erstellen und Warten von Ablage-Shares für Vorlagen und Script-Komponenten ist Aufgabe des Kunden.  
Das Mail-Produktmanagement steht für Fragen zu Realisierbarkeit und Auswirkungen beratend zur Verfügung.  
#### 2.6.7.2. Setzen und Warten von AD-Attributen  
...
Das Mail-Produktmanagement steht für Fragen zu Realisierbarkeit und Auswirkungen beratend zur Verfügung.  
#### 2.6.7.3. Konfigurationsanpassungen  
...
#### 2.6.7.4. Probleme und Fragen im laufenden Betrieb  
Bei prinzipiellen technischen Problemen unterstützt das Mail-Produktmanagement bei der Ursachenforschung, arbeitet Lösungsvorschläge aus und stellt gegebenenfalls den Kontakt zum Hersteller des Produkts her.  
...
#### 2.6.7.5. Unterstützte Versionen  
...
Bei prinzipiellen technischen Problemen unterstützt das Mail-Produktmanagement bei der Ursachenforschung, arbeitet Lösungsvorschläge aus und stellt gegebenenfalls den Kontakt zum Hersteller des Produkts her.  
#### 2.6.7.7. Anpassungen am Code des Produkts  
